...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar w-full max-w-[343px] rounded-md border border-purple-300 bg-background p-8 [--cell-size:--spacing(8)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
